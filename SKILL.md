...
description: Deeply research an internal software system using Confluence, Jira, GitHub history, and current code. Reconstruct current behavior, historical evolution, motivations, contradictions, and evidence before architecture visualization or knowledge-sharing preparation.
---
...
Before declaring research complete, check `GPT56-CHECKLIST.md` and confirm the Research Output section.
